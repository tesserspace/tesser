...
pub use time::{from_millis, from_nanos, now as utc_now, to_millis, to_nanos, NanoTime};
...
pub struct Tick {
    ...
    pub size: Quantity,
    pub side: Side,
    pub exchange_timestamp: NanoTime,
    pub received_at: NanoTime,
}
